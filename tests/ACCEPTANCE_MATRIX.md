...
| quick/solid/prime Artifact graphs and external Prime approval | `flows.test.ts`, `flows.json` golden |
...
| Archive dry-run, task/Gate block, Spec merge, archive move | `archive.test.ts`, `spec-merger.test.ts` |
