...
- Run `xforge state --change <id> --field nextActions --field diagnostics --field change.governance --field change.nextArtifact` and consume only the current-revision ready Clarify Action.
