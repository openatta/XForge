...
- 先运行 `xforge state --change <id> --field nextActions --field diagnostics --field change.governance --field change.nextArtifact`，只消费当前 revision 的 ready Clarify Action，不因熟悉 Major 顺序而猜路径。
