...
- Run `xforge state --change <id> --field nextActions --field diagnostics --field change`, consume only the current-revision ready Design Action, and reread every Action input.
