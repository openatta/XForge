...
- Run `xforge state --change <id> --field nextActions --field diagnostics --field change` and resolve the mode as `verify-only`, `verify-and-archive`, or `archive-current`; without explicit archive authority, verify only.
