...
```bash
npm install --save-dev --save-exact @xforge/cli@0.8.0
xforge version --text
```
...
runbook](https://github.com/openatta/XForge/blob/v0.8.0/AGENT_INSTALL.md) for the
...
[documentation index](https://github.com/openatta/XForge/blob/v0.8.0/docs/index.md),
or go straight to
[concepts and architecture](https://github.com/openatta/XForge/blob/v0.8.0/docs/concepts-and-architecture.md)
and the [governance model](https://github.com/openatta/XForge/blob/v0.8.0/docs/governance-model.md).
...
Apache-2.0. See the repository [LICENSE](https://github.com/openatta/XForge/blob/v0.8.0/LICENSE)
and [NOTICE](https://github.com/openatta/XForge/blob/v0.8.0/NOTICE).
