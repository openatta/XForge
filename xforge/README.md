...
runbook](https://github.com/openatta/XForge/blob/v0.8.5/AGENT_INSTALL.md) for the
...
[documentation index](https://github.com/openatta/XForge/blob/v0.8.5/docs/index.md),
or go straight to
[concepts and architecture](https://github.com/openatta/XForge/blob/v0.8.5/docs/concepts-and-architecture.md)
and the [governance model](https://github.com/openatta/XForge/blob/v0.8.5/docs/governance-model.md).
...
Apache-2.0. See the repository [LICENSE](https://github.com/openatta/XForge/blob/v0.8.5/LICENSE)
and [NOTICE](https://github.com/openatta/XForge/blob/v0.8.5/NOTICE).
