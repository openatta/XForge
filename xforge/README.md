...
runbook](https://github.com/openatta/XForge/blob/v0.7.5/AGENT_INSTALL.md) for the
...
including the [CLI guide](https://github.com/openatta/XForge/blob/v0.7.5/docs/cli-tool-usage.md)
and [governance design](https://github.com/openatta/XForge/blob/v0.7.5/docs/governance-control-plane-design.md).
...
Apache-2.0. See the repository [LICENSE](https://github.com/openatta/XForge/blob/v0.7.5/LICENSE)
and [NOTICE](https://github.com/openatta/XForge/blob/v0.7.5/NOTICE).
